...
environment-based configuration and model auto-discovery.
"""
...
from app.models import (
    Tenant, Site, Device, DeviceCredential, Template, Job, Backup, Alert,
...
def get_database_url() -> str:
    ...
    Returns:
        str: Database URL for Alembic migrations.
    """
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            compare_server_default=True,
            include_schemas=True,
            # Include object name in migration for better readability
